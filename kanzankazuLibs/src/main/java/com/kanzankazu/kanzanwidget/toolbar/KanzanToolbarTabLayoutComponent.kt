...
class KanzanToolbarTabLayoutComponent @JvmOverloads constructor(
    private val _context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : AppBarLayout(_context, attrs, defStyleAttr) {
    ...
    private fun extractAttributes(attrs: AttributeSet) {
        val typedArray =
            _context.obtainStyledAttributes(attrs, R.styleable.KanzanToolbarTabLayoutComponent)
        mNavColor = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_navColor,
            mNavColor
        )
        mNavBackgroundColor = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_navBackgroundColor,
            mNavBackgroundColor
        )
        mNavigationIcon = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_navigationIcon,
            mNavigationIcon
        )
        mSubTitleFontStyle = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_subTitleFontStyle,
            mSubTitleFontStyle
        )
        mTitleFontStyle = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_subTitleFontStyle,
            mTitleFontStyle
        )
        mSubTitleColor = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_subTitleColor,
            mSubTitleColor
        )
        mTitleColor = typedArray.getResourceId(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_titleColor,
            mTitleColor
        )
        mIsSubtitleCentered = typedArray.getBoolean(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_isSubtitleCentered,
            mIsSubtitleCentered
        )
        mIsTitleCentered = typedArray.getBoolean(
            R.styleable.KanzanToolbarTabLayoutComponent_ktc_isTitleCentered,
            mIsTitleCentered
        )
        mSubTitle = typedArray.getString(R.styleable.KanzanToolbarTabLayoutComponent_ktc_subTitle)
            ?: mSubTitle
        mTitle =
            typedArray.getString(R.styleable.KanzanToolbarTabLayoutComponent_ktc_title) ?: mTitle
        typedArray.recycle()
    }

    private fun initView() {
        val inflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
        inflater.inflate(R.layout.layout_toolbar_tablayout, this).apply {
