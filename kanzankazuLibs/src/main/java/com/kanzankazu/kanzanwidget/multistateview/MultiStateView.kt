...
@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : FrameLayout(context, attrs, defStyle) {
    ...
    /**
     * Returns the [View] associated with the [com.kanzankazu.kanzanwidget.multistateview.ViewState]
     *
     * @param state The [com.kanzankazu.kanzanwidget.multistateview.ViewState] with to return the view for
     * @return The [View] associated with the [com.kanzankazu.kanzanwidget.multistateview.ViewState], null if no view is present
     */
     ...
     * @param state         The [com.kanzankazu.kanzanwidget.multistateview.ViewState]to set
     * @param switchToState If the [com.kanzankazu.kanzanwidget.multistateview.ViewState] should be switched to
     */
    ...
    /**
     * Sets the [View] for the given [com.kanzankazu.kanzanwidget.multistateview.ViewState]
     *
    ...
    /**
     * Shows the [View] based on the [com.kanzankazu.kanzanwidget.multistateview.ViewState]
     */
