...
data class RevealAnimationSettings(val centerX: Int, val centerY: Int, val width: Int, val height: Int) : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<RevealAnimationSettings> {
        ...
        override fun newArray(size: Int): Array<RevealAnimationSettings?> = arrayOfNulls(size)
    }
